...
Route.get("/kalender-pribadi", "KalenderPribadiController.index");
Route.post("/kalender-pribadi", "KalenderPribadiController.store");
Route.get("/kalender-pribadi/:id", "KalenderPribadiController.show");
Route.put("/kalender-pribadi/:id", "KalenderPribadiController.update");
Route.delete("/kalender-pribadi/:id", "KalenderPribadiController.destroy");
